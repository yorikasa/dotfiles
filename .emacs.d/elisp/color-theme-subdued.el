  ...
  (color-theme-install
   '(color-theme-subdued
     ((foreground-color . "#d3d7cf")
      ...
      (cursor-color . "#ffffff") ; medium chameleon 73d216
      (mouse-color . "#ffffff"))
     ...
     (font-lock-doc-face ((t (:foreground "#77507b")))) ; plum 77507b
     (font-lock-doc-string-face ((t (:foreground "#77507b")))) ; plum
     (font-lock-string-face ((t (:foreground "#438820")))) ; plum
     ...
     (mode-line ((t (:background "#000000" :foreground "#eeeeee"))))
     (mode-line-buffer-id ((t (:background "#000000" :foreground "goldenrod1"))))
     (mode-line-inactive ((t (:background "#000000" :foreground "#222222"))))
     (minibuffer-prompt ((t (:foreground "#729fcf")))) ; light sky blue
     (region ((t (:background "#2e3426")))) ;; 2e3426
     ...
     ;; Line highlighting
     (highlight ((t (:background "royalblue" :foreground nil))))
